    ...
    sidebar.innerHTML = `
        ...
        <div class="sidebar-menu p-3">
            ...
            <button onclick="navigate('approval')" class="sidebar-item w-full flex items-center gap-3 px-3 py-2.5 rounded-lg mb-1 ${state.currentPage==='approval'?'bg-primary-50 text-primary-700 font-medium':'text-gray-600 hover:bg-gray-50'}">
             ...
             <!-- PENTADBIRAN: Log Aktiviti & Pengurusan Pengguna – hanya sorok untuk Pemerhati -->
             ${peranan !== 'Pemerhati' ? `
             ...
             ` : ''}
             <!-- Import Data & Pegawai Penyelaras – tunjuk untuk semua kecuali Petugas 1 -->
             ${!peranan.startsWith('Petugas 1') ? `
             ...
             ` : ''}
             <!-- KETUA KELUARGA – tunjuk untuk SEMUA peranan -->
             ...
             <!-- PPU, Soal Selidik, INFO PARTI, SOKONGAN – tunjuk untuk selain Petugas 1 -->
             ${!peranan.startsWith('Petugas 1') ? `
