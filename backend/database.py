...
def init_db():
    ...
    try:
        ...
        """)
        cursor.execute("""
            CREATE INDEX IF NOT EXISTS idx_pengundi_status_fizikal ON pengundi(status_fizikal)
        """)
        cursor.execute("""
            CREATE INDEX IF NOT EXISTS idx_pengundi_tahun_lahir ON pengundi(tahun_lahir)
        """)
        cursor.execute("""
